...
\input{sections/00_common_setup}
\input{sections/01_ownership_cone_pdpo}
\input{sections/02_support_handoff_replay}
\input{sections/03_profile_swap_policy_gradient}
\input{sections/04_tomorrows_mistake}
\input{sections/05_checkpoint_fork_queries}
